...
class NotesFragment : Fragment(R.layout.fragment_notes) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbar.setTitleTextAppearance(requireContext(), R.style.MyTitleTextAppearance);
        ...
        val dividerItemDecoration = MyDividerItemDecoration(
            resources.getDimensionPixelSize(R.dimen.divider_short)
        )
        ...
        binding.floatingActionButton.setOnClickListener {
            ...
            fragmentListener?.switchToFragment(EditFragment.newInstance(note))
        }
